...
float scaleAndPlaceX(float x) {
	float offset = 2500;
	return (SCALE*x) + offset;
}

float scaleAndPlaceY(float y) {
	return (SCALE*y) + yOffset;
}
float scaleAndPlaceZ(float z) {
	float offset = 10000;
...
void AddICT290Objects()
{
	...
	* Hub World Build f1
	*/
	int hub = builder.NewArea();

	//floor
	builder.StartObject();
		builder.CreateHorizontal(CVector(scaleAndPlaceX(0), scaleAndPlaceY(0), scaleAndPlaceZ(0)),
			CVector(scaleAndPlaceX(1000), scaleAndPlaceY(0), scaleAndPlaceZ(0)),
			(SCALE*1600), GEO_H_UP, tex_info);
	builder.EndObject();
	
	//roof
	builder.StartObject();
		builder.CreateHorizontal(CVector(scaleAndPlaceX(0), scaleAndPlaceY(500), scaleAndPlaceZ(0)),
			CVector(scaleAndPlaceX(1000), scaleAndPlaceY(500), scaleAndPlaceZ(0)),
			(SCALE * 1600), GEO_H_UP, tex_info);
	builder.EndObject();

	//left walls
	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(0), scaleAndPlaceY(0), scaleAndPlaceZ(0)),
			CVector(scaleAndPlaceX(0), scaleAndPlaceY(0), scaleAndPlaceZ(300)),
			(SCALE * 500), GEO_V_RIGHT, tex_info);
	builder.EndObject();
	
	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(0), scaleAndPlaceY(300), scaleAndPlaceZ(300)),
			CVector(scaleAndPlaceX(0), scaleAndPlaceY(300), scaleAndPlaceZ(500)),
			(SCALE * 200), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();//door
		builder.CreateVertical(CVector(scaleAndPlaceX(0), scaleAndPlaceY(0), scaleAndPlaceZ(300)),
			CVector(scaleAndPlaceX(0), scaleAndPlaceY(0), scaleAndPlaceZ(500)),
			(SCALE * 300), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(0), scaleAndPlaceY(0), scaleAndPlaceZ(500)),
			CVector(scaleAndPlaceX(0), scaleAndPlaceY(0), scaleAndPlaceZ(1100)),
			(SCALE * 500), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(0), scaleAndPlaceY(300), scaleAndPlaceZ(1100)),
			CVector(scaleAndPlaceX(0), scaleAndPlaceY(300), scaleAndPlaceZ(1300)),
			(SCALE * 200), GEO_V_RIGHT, tex_info);
	builder.EndObject();
	printf("1");

	builder.StartObject();//door
		builder.CreateVertical(CVector(scaleAndPlaceX(0), scaleAndPlaceY(0), scaleAndPlaceZ(1100)),
			CVector(scaleAndPlaceX(0), scaleAndPlaceY(0), scaleAndPlaceZ(1300)),
			(SCALE * 300), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(0), scaleAndPlaceY(0), scaleAndPlaceZ(1300)),
			CVector(scaleAndPlaceX(0), scaleAndPlaceY(0), scaleAndPlaceZ(1600)),
			(SCALE * 500), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(400), scaleAndPlaceY(0), scaleAndPlaceZ(1600)),
			CVector(scaleAndPlaceX(400), scaleAndPlaceY(0), scaleAndPlaceZ(1800)),
			(SCALE * 500), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	//right walls
	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(1000), scaleAndPlaceY(0), scaleAndPlaceZ(0)),
			CVector(scaleAndPlaceX(1000), scaleAndPlaceY(0), scaleAndPlaceZ(300)),
			(SCALE * 500), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(1000), scaleAndPlaceY(300), scaleAndPlaceZ(300)),
			CVector(scaleAndPlaceX(1000), scaleAndPlaceY(300), scaleAndPlaceZ(500)),
			(SCALE * 200), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();//door
		builder.CreateVertical(CVector(scaleAndPlaceX(1000), scaleAndPlaceY(0), scaleAndPlaceZ(300)),
			CVector(scaleAndPlaceX(1000), scaleAndPlaceY(0), scaleAndPlaceZ(500)),
			(SCALE * 300), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(1000), scaleAndPlaceY(0), scaleAndPlaceZ(500)),
			CVector(scaleAndPlaceX(1000), scaleAndPlaceY(0), scaleAndPlaceZ(1100)),
			(SCALE * 500), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(1000), scaleAndPlaceY(300), scaleAndPlaceZ(1100)),
			CVector(scaleAndPlaceX(1000), scaleAndPlaceY(300), scaleAndPlaceZ(1300)),
			(SCALE * 200), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();//door
		builder.CreateVertical(CVector(scaleAndPlaceX(1000), scaleAndPlaceY(0), scaleAndPlaceZ(1100)),
			CVector(scaleAndPlaceX(1000), scaleAndPlaceY(0), scaleAndPlaceZ(1300)),
			(SCALE * 300), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(1000), scaleAndPlaceY(0), scaleAndPlaceZ(1300)),
			CVector(scaleAndPlaceX(1000), scaleAndPlaceY(0), scaleAndPlaceZ(1600)),
			(SCALE * 500), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(600), scaleAndPlaceY(0), scaleAndPlaceZ(1600)),
			CVector(scaleAndPlaceX(600), scaleAndPlaceY(0), scaleAndPlaceZ(1800)),
			(SCALE * 500), GEO_V_RIGHT, tex_info);
	builder.EndObject();
	printf("2");
	//front walls
	...
	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(0), scaleAndPlaceY(0), scaleAndPlaceZ(1600)),
			CVector(scaleAndPlaceX(400), scaleAndPlaceY(0), scaleAndPlaceZ(1600)),
			(SCALE * 500), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(200), scaleAndPlaceY(500), scaleAndPlaceZ(2000)),
			CVector(scaleAndPlaceX(800), scaleAndPlaceY(500), scaleAndPlaceZ(2000)),
			(SCALE * 250), GEO_V_RIGHT, tex_info);
	builder.EndObject();
	printf("is it here?\n");
	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(400), scaleAndPlaceY(300), scaleAndPlaceZ(1600)),
			CVector(scaleAndPlaceX(600), scaleAndPlaceY(300), scaleAndPlaceZ(1600)),
			(SCALE * 200), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();//door
		builder.CreateVertical(CVector(scaleAndPlaceX(400), scaleAndPlaceY(0), scaleAndPlaceZ(1600)),
			CVector(scaleAndPlaceX(600), scaleAndPlaceY(0), scaleAndPlaceZ(1600)),
			(SCALE * 300), GEO_V_RIGHT, tex_info);
	builder.EndObject();
	//back walls
	builder.StartObject();
	...
	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(200), scaleAndPlaceY(500), scaleAndPlaceZ(1800)),
			CVector(scaleAndPlaceX(400), scaleAndPlaceY(500), scaleAndPlaceZ(1800)),
			(SCALE * 250), GEO_V_RIGHT, tex_info);
	builder.EndObject();
	...
	*/
	...
	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(0), scaleAndPlaceY(0), scaleAndPlaceZ(1300)),
			CVector(scaleAndPlaceX(0), scaleAndPlaceY(0), scaleAndPlaceZ(2000)),
			(SCALE * 500), GEO_V_RIGHT, tex_info);
	builder.EndObject();
	...
	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(1000), scaleAndPlaceY(0), scaleAndPlaceZ(1300)),
			CVector(scaleAndPlaceX(1000), scaleAndPlaceY(0), scaleAndPlaceZ(2000)),
			(SCALE * 500), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	//front walls
	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(0), scaleAndPlaceY(0), scaleAndPlaceZ(2000)),
			CVector(scaleAndPlaceX(1000), scaleAndPlaceY(0), scaleAndPlaceZ(2000)),
			(SCALE * 500), GEO_V_RIGHT, tex_info);
	builder.EndObject();
	...
	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(0), scaleAndPlaceY(0), scaleAndPlaceZ(0)),
			CVector(scaleAndPlaceX(400), scaleAndPlaceY(0), scaleAndPlaceZ(0)),
			(SCALE * 500), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(600), scaleAndPlaceY(0), scaleAndPlaceZ(0)),
			CVector(scaleAndPlaceX(1000), scaleAndPlaceY(0), scaleAndPlaceZ(0)),
			(SCALE * 500), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();
		builder.CreateVertical(CVector(scaleAndPlaceX(400), scaleAndPlaceY(300), scaleAndPlaceZ(0)),
			CVector(scaleAndPlaceX(600), scaleAndPlaceY(300), scaleAndPlaceZ(0)),
			(SCALE * 200), GEO_V_RIGHT, tex_info);
	builder.EndObject();

	builder.StartObject();//door
		builder.CreateVertical(CVector(scaleAndPlaceX(400), scaleAndPlaceY(0), scaleAndPlaceZ(0)),
			CVector(scaleAndPlaceX(600), scaleAndPlaceY(0), scaleAndPlaceZ(0)),
			(SCALE * 300), GEO_V_RIGHT, tex_info);
	builder.EndObject();
	geo_manage.EnableArea(hub);
...
void CreateTextures()
{
	...
	image = tp.LoadTexture("data/doge.raw", 1920, 1080);
	tp.CreateTexture(220, image, 1920, 1080);
...
void DisplayBanner()
{
	...
	if(!defined){
		glNewList(10000, GL_COMPILE); //high number because idk what the hell shay is using
			glBegin(GL_POLYGON);	
				glTexCoord2f(0, 1);
				glVertex3f(-50, -750, 0);
	...
	glPushMatrix();
		glTranslatef(14990, 11090, 25000);
		glCallList(10000);
	glPopMatrix();

	glPushMatrix();
		glTranslatef(17010, 11090, 25000);
		glCallList(10000);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(16000, 11300, 25000);
	glBindTexture(GL_TEXTURE_2D, tp.GetTexture(220));
	glBegin(GL_POLYGON);
		glTexCoord2f(0, 1);
		glVertex3f(-960, -540, 0);
...
void DisplayStepBricks ()
{
	...
	for (int j = 0; j < 2; j++)
	{
		glPushMatrix();
			...
			for (i = 478; i < 487; i ++) glCallList(i);
